...
class MainWindow(QMainWindow):
    ...
    def preview_path_change(self):
        """
        Метод проверяет ввод пользователя на наличие ключевой информации на наличие обратных слешей и далее
        передает данные в аттрибуты класса.
    ...
    def change_path_in_ma_file(self):
        """
        Метод меняет данные файл нода в файле.
        :return: None
        """
